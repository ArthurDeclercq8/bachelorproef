...
\vspace{1em}De derde module: predictor.py, laadt het opgeslagen model en berekent voor een gegeven werknemer-taakcombinatie de kans dat de werknemer de beste keuze is. Daarvoor wordt de methode: predictproba gebruikt, die twee kansen teruggeeft: de kans op klasse 0 (niet de beste keuze) en de kans op klasse 1 (de beste keuze). Enkel die laatste waarde wordt als ML-score doorgegeven aan de toewijzingslogica.
\begin{figure}
    \centering
