...
\vspace{1em}In Hoofdstuk~\ref{ch:resultaten} wordt het ontwikkelde systeem vergeleken met andere taakallocatiebenaderingen en worden de resultaten hiervan besproken.

\vspace{1em}Ten slotte in Hoofdstuk~\ref{ch:conclusie} wordt er een conclusie geformuleerd aan de hand van de antwoorden op de onderzoeksvragen.