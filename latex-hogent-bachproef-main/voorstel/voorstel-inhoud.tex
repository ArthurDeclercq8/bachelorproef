...
\vspace{1em}Voor deze bachelorproef wordt de focus gelegd op 1 groot bedrijf:
Cisco, waar ongeveer de helft van de medewerkers aangeeft over 70 uur per week te werken \autocite{Xavier2025} . Aangezien overmatige werkdruk rechtstreeks verband houdt met hogere burnout percentages, is Cisco een perfecte casus.

\vspace{1em}De doelgroep bestaat uit IT-professionals binnen deze organisatie die dagelijks geconfronteerd worden met hoge stress door strakke deadlines en complexe projecten. Door het probleem te kaderen binnen 1 van de meest stressvolle bedrijven voor IT'ers, wordt het mogelijk een praktische en algemene oplossing te ontwikkelen.
...
\begin{itemize}
    ...
    \item literatuurstudie - 9 weken
    \item haalbaarheidsonderzoek -3 weken
    \item analyse van benodigde ontwikkelresources - 4 weken
    \item risico- en impactanalyse - 1 week
\end{itemize}

\vspace{1em}De eerste stap in het onderzoek is een requirements-analyse. Hierin wordt vastgesteld welke functies het AI-systeem allemaal moet kunnen vervullen. Dit wordt samen met de co-promotor gedaan. Er wordt ook geanalyseerd welke soorten data hiervoor nodig zijn. Door deze analyse ontstaat een gedetailleerd overzicht van de functionele en niet-functionele eisen van het systeem.
...
\vspace{1em}Indien het concept haalbaar is, wordt een gedetailleerde analyse van de benodigde ontwikkelresources uitgevoerd. Dit omvat zowel de technische componenten (softwaretools, frameworks, ...) als de organisatorische ( betrokken personeel, infrastructuur, ...).
